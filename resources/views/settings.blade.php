        ...
        <div class="row">
            <form class="form-horizontal" method="post" action="{{route('configure')}}" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <label class="btn btn-default form-control">
                                logo şəkili yükləyin<input type="file" name="logo"
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="background">Sayt axra fonu</label>
                        <div class="col-md-4">
                            <label class="btn btn-default form-control">
                                arxa fon şəkili yükləyin<input type="file" name="background" id="background"
